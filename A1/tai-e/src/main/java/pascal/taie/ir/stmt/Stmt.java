 ...
 */
public interface Stmt extends Indexable {//用于表示程序中的某一行语句，有对应api可以获取当前语句定义的变量和使用的变量
     ...
     */
    Optional<LValue> getDef();//获取某条语句中定义的表达式中的变量

    /**
     * @return a list of right-value expressions used in this Stmt.
     */
    List<RValue> getUses();//获取某条语句中使用的表达式中的变量
